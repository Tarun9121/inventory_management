...
<%
    // Check if the user is either an admin or a supplier
    if (session.getAttribute("adminObj") == null && session.getAttribute("supplierId") == null) {
        response.sendRedirect("login.jsp"); // Redirect to login if neither admin nor supplier is logged in
        return;
    }
