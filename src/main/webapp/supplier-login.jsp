...
<html>
<head>
    <title>Supplier Login - Wearfinity</title>
...
<div class="overlay">
    <div class="container">
        <div class="login-card">
            ...
            <form action="SupplierLoginServlet" method="post" onsubmit="return validateLogin()">
                <div class="mb-3">
            ...
            <div class="mt-3 text-center">
                <p>Not a supplier? <a href="index.jsp">Go back</a></p>
